 ...
 */
export function CurrentWordCard({ word, category, difficulty }) {
    ...
    <div className="relative w-full max-w-lg mx-auto bg-gradient-to-b from-slate-800 to-slate-900 border-2 border-blue-400/50 rounded-3xl p-6 shadow-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 text-xs text-slate-400 hover:text-white bg-slate-800/80 border border-slate-700 px-2.5 py-1 rounded-lg transition-colors"
